...
$sql = "SELECT * FROM member_associate";
...
<!-- 					 <div class="col-sm-4">
			...
			<div class="team">
				<div class="center wow fadeInDown">
					<h2>Associate of <span>Organic Lab.</span></h2>
					<p class="lead">Our target is the become the highest level organic lab in all the world. <br> We have the best associates in the lab.</p>
				</div>
				...
				<div class="row clearfix">
					...
					<?php  }?>	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<div class="pull-left">
									<a class="preview" rel="prettyPhoto"><img class="media-object" src="images/associate/<?php echo $row['id']; ?>.jpg" alt="" width="145px"></a>
								</div>
